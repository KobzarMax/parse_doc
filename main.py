...
def check_apartment_vs_building(text: str) -> dict:
    ...
    prompt = (
        ...
        "WICHTIGE HINWEISE ZUR RECHNUNGSEMPFÄNGER:\n"
        "- Geschäftsentitäten (mit 'GmbH', 'UG', 'AG', 'KG', 'Verwaltung', 'Management' etc.) sind GEBÄUDE/VERWALTUNGSENTITÄTEN, NICHT einzelne Mieter\n"
        "- Persönliche Namen (z.B. 'Max Müller', 'Familie Schmidt') deuten auf einzelne Mietparteien hin\n"
        "- Behörden, öffentliche Einrichtungen deuten auf Gesamtgebäude hin\n\n"
        ...
        "- Persönlicher Name als Rechnungsempfänger (einzelner Mieter)\n"
        ...
        "- Geschäftsentität aus Empfänger (GmbH, UG, AG, KG, Verwaltung, Management)\n"
        "- Hausverwaltung oder Eigentümergemeinschaft oder Immobiliengesellschaft als Empfänger\n"
        "- Gesamtgebäude-Verbrauch oder -Kosten\n"
        "- Bezeichnungen wie 'Mehrfamilienhaus', 'Gesamtobjekt', 'Haus-Nr.', 'Liegenschaften'\n"
        ...
        "- 0 kWh oder zusammengefasste Verbrauchswerte können auf Managementdokument hindeuten\n\n"
